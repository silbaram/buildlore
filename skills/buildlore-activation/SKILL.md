...
1. Read `compile hierarchy status --project <id> --run <id> --json`. Confirm finalization and required independent review. Present the selected project, reviewed generation, changes and unresolved gaps to the user.
