...
const entries: readonly TrackingEntry[] = [
  ...
  entry('always-track-hierarchical-authority-archive',
    'projects/*/.llmwiki/buildlore-hierarchy/archives/*.json', 'buildlore',
    'always-track', 'portable', 'authoritative', 'none', 'low', 'not-regenerable',
    'Validated immutable prior authority for migration recovery; never a current retrieval input.'),
  entry('always-track-project-knowledge-export',
    'projects/*/wiki/buildlore-hierarchy/knowledge.json', 'buildlore',
    'always-track', 'portable', 'derived', 'none', 'low', 'from-tracked-state',
    'Readable knowledge record projection; the approved authority remains canonical.'),
  entry('always-track-project-knowledge-history',
    'projects/*/.llmwiki/buildlore-hierarchy/knowledge-history/objects/*.json', 'buildlore',
    'always-track', 'portable', 'authoritative', 'none', 'low', 'not-regenerable',
    'Immutable generation records required to replay approved knowledge after cloning.'),
  entry('always-track-project-evidence-export',
    'projects/*/wiki/buildlore-hierarchy/evidence.json', 'buildlore',
    'always-track', 'portable', 'derived', 'none', 'low', 'from-tracked-state',
    'Readable sanitized evidence projection bound to the selected knowledge generation.'),
  ...
  entry('always-track-session-promotion-proof',
    'projects/*/.llmwiki/buildlore-session/proofs/*.json', 'buildlore', 'always-track',
    'portable', 'authoritative', 'none', 'low', 'not-regenerable',
    'Body-free proof binding an approved session page to its current compiler sources.'),
  ...
  entry('policy-track-session-approving-candidate',
    'projects/*/.llmwiki/buildlore-session/approving/*.json', 'buildlore', 'policy-track',
    'portable', 'derived', 'none', 'review-required', 'from-tracked-state',
    'Claimed session candidate retained for exact interrupted-approval recovery.'),
  entry('policy-track-session-pending-candidate',
    'projects/*/.llmwiki/buildlore-session/pending/*.json', 'buildlore', 'policy-track',
    'portable', 'derived', 'none', 'review-required', 'from-tracked-state',
    'Sanitized review material awaiting explicit candidate approval.'),
